...
{
    [XUnitCases]
    public class when_contains_second_activity_and_one_complete_travel_and_one_in_transit_travel : DbSpec
    {
        private static DayActivity day;

        [Fact]
        public void test_when_contains_second_activity_and_one_complete_travel_and_one_in_transit_travel()
        {
            Given("context", () =>
            {
            ...
            Then("should_devide_second_activity_to_departure_and_arrival_location_of_first_travel", () =>
            {
