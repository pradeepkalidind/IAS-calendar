...
{
    [XUnitCases]
    public class when_contains_first_activity_and_one_complete_travel : DbSpec
    {
        private static DayActivity day;

        [Fact]
        public void test_when_contains_first_activity_and_one_complete_travel()
        {
            Given("context", () =>
            {
            ...
            Then("should_devide_first_activity_to_departure_and_arrival_locations", () =>
            {
