...
{
    [XUnitCases]
    public class when_contains_two_activities_and_one_complete_travel : DbSpec
    {
        private static DayActivity day;

        [Fact]
        public void test_when_contains_two_activities_and_one_complete_travel()
        {
            Given("context", () =>
            {
            ...
            Then("should_allocate_first_activity_to_departure_location_and_second_activity_to_arrival_location", () =>
            {
